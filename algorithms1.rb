...
p largest_palindrome_product  # => [906609, 913, 993]
...
def sum_of_fib
  ...
  sum  # return the sum of the even-valued terms not exceeding 4000000
end

p sum_of_fib  # => 4613732
