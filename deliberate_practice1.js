...
console.log(pairProducts([3, 4, 5, 6]));
...
console.log(productsBoth([1, 2], [3, 4, 5]));
...
console.log(pairSumsTo10([2, 4, 6, 7]));
console.log(pairSumsTo10([1, 2, 3, 4]));
...
console.log(largestPairProduct([5, -2, 1, -9, -7, 2, 6]));
console.log(largestPairProduct([-100, -10, -1, 0, 1, 10, 100]));
